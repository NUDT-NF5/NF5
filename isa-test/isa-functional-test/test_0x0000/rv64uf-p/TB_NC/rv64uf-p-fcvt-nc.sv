...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000240) |=>##1 IFID_NowPC_value (32'h0000000000000240+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000000000022c) |=>##1 IFID_NowPC_value (32'h000000000000022c+32'h8);
