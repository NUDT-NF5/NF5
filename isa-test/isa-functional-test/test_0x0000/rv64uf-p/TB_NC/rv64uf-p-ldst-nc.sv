...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000188) |=>##1 IFID_NowPC_value (32'h0000000000000188+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000174) |=>##1 IFID_NowPC_value (32'h0000000000000174+32'h8);
