...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000878) |=>##1 IFID_NowPC_value (32'h0000000000000878+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000864) |=>##1 IFID_NowPC_value (32'h0000000000000864+32'h8);
