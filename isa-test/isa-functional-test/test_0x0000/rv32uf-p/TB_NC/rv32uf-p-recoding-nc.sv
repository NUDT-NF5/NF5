...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000001a4) |=>##1 IFID_NowPC_value (32'h000001a4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000190) |=>##1 IFID_NowPC_value (32'h00000190+32'h8);
