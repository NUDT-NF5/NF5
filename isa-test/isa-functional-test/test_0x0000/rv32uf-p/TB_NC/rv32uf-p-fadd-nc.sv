...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000328) |=>##1 IFID_NowPC_value (32'h00000328+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000314) |=>##1 IFID_NowPC_value (32'h00000314+32'h8);
