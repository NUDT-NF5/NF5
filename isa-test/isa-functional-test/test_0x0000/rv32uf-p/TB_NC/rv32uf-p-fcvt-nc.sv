...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000001b0) |=>##1 IFID_NowPC_value (32'h000001b0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000019c) |=>##1 IFID_NowPC_value (32'h0000019c+32'h8);
