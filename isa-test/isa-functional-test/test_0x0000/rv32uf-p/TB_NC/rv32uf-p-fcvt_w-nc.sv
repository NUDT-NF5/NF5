...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000050c) |=>##1 IFID_NowPC_value (32'h0000050c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000004f8) |=>##1 IFID_NowPC_value (32'h000004f8+32'h8);
