...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000003ac) |=>##1 IFID_NowPC_value (32'h000003ac+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000398) |=>##1 IFID_NowPC_value (32'h00000398+32'h8);
