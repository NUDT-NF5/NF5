...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000160) |=>##1 IFID_NowPC_value (32'h00000160+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000014c) |=>##1 IFID_NowPC_value (32'h0000014c+32'h8);
