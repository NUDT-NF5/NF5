...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000021c) |=>##1 IFID_NowPC_value (32'h0000021c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000208) |=>##1 IFID_NowPC_value (32'h00000208+32'h8);
