...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000208) |=>##1 IFID_NowPC_value (32'h0000000000000208+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000001f4) |=>##1 IFID_NowPC_value (32'h00000000000001f4+32'h8);
