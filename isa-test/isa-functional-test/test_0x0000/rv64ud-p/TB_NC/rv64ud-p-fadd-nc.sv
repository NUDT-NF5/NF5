...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000328) |=>##1 IFID_NowPC_value (32'h0000000000000328+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000314) |=>##1 IFID_NowPC_value (32'h0000000000000314+32'h8);
