...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000002c0) |=>##1 IFID_NowPC_value (32'h00000000000002c0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000002ac) |=>##1 IFID_NowPC_value (32'h00000000000002ac+32'h8);
