...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000052dc) |=>##1 IFID_NowPC_value (32'h00000000000052dc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000052cc) |=>##1 IFID_NowPC_value (32'h00000000000052cc+32'h8);
