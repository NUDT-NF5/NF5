...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00005258) |=>##1 IFID_NowPC_value (32'h00005258+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00005248) |=>##1 IFID_NowPC_value (32'h00005248+32'h8);
