...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bcc) |=>##1 IFID_NowPC_value (32'h0000000000002bcc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bbc) |=>##1 IFID_NowPC_value (32'h0000000000002bbc+32'h8);
