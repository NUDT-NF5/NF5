...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002be0) |=>##1 IFID_NowPC_value (32'h0000000000002be0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bd0) |=>##1 IFID_NowPC_value (32'h0000000000002bd0+32'h8);
