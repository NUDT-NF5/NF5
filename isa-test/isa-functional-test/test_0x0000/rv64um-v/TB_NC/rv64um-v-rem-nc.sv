...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bc4) |=>##1 IFID_NowPC_value (32'h0000000000002bc4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bb4) |=>##1 IFID_NowPC_value (32'h0000000000002bb4+32'h8);
