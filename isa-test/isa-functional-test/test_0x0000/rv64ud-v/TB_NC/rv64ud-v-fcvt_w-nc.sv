...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000003328) |=>##1 IFID_NowPC_value (32'h0000000000003328+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000003318) |=>##1 IFID_NowPC_value (32'h0000000000003318+32'h8);
