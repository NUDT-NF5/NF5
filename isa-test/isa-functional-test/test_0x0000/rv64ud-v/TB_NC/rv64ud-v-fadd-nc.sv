...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002ce8) |=>##1 IFID_NowPC_value (32'h0000000000002ce8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002cd8) |=>##1 IFID_NowPC_value (32'h0000000000002cd8+32'h8);
