...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002db0) |=>##1 IFID_NowPC_value (32'h0000000000002db0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002da0) |=>##1 IFID_NowPC_value (32'h0000000000002da0+32'h8);
