...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002ca0) |=>##1 IFID_NowPC_value (32'h0000000000002ca0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002c90) |=>##1 IFID_NowPC_value (32'h0000000000002c90+32'h8);
