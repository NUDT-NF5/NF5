...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b94) |=>##1 IFID_NowPC_value (32'h0000000000002b94+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b84) |=>##1 IFID_NowPC_value (32'h0000000000002b84+32'h8);
