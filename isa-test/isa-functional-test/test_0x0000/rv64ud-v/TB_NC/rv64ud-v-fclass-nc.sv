...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002c04) |=>##1 IFID_NowPC_value (32'h0000000000002c04+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bf4) |=>##1 IFID_NowPC_value (32'h0000000000002bf4+32'h8);
