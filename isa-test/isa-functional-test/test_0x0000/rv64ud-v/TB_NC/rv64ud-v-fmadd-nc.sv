...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d50) |=>##1 IFID_NowPC_value (32'h0000000000002d50+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d40) |=>##1 IFID_NowPC_value (32'h0000000000002d40+32'h8);
