...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000225c) |=>##1 IFID_NowPC_value (32'h0000225c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002248) |=>##1 IFID_NowPC_value (32'h00002248+32'h8);
