...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002f5c) |=>##1 IFID_NowPC_value (32'h0000000000002f5c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002f4c) |=>##1 IFID_NowPC_value (32'h0000000000002f4c+32'h8);
