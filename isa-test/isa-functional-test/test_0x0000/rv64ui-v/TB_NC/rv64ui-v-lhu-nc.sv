...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d58) |=>##1 IFID_NowPC_value (32'h0000000000002d58+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d48) |=>##1 IFID_NowPC_value (32'h0000000000002d48+32'h8);
