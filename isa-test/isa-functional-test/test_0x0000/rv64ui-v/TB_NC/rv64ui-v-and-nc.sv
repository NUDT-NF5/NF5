...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000003030) |=>##1 IFID_NowPC_value (32'h0000000000003030+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000003020) |=>##1 IFID_NowPC_value (32'h0000000000003020+32'h8);
