...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002be8) |=>##1 IFID_NowPC_value (32'h0000000000002be8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bd8) |=>##1 IFID_NowPC_value (32'h0000000000002bd8+32'h8);
