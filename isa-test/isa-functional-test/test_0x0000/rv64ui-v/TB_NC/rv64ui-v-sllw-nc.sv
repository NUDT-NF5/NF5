...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000003044) |=>##1 IFID_NowPC_value (32'h0000000000003044+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000003034) |=>##1 IFID_NowPC_value (32'h0000000000003034+32'h8);
