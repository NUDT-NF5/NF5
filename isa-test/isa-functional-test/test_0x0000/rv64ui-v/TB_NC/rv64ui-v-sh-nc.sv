...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002f50) |=>##1 IFID_NowPC_value (32'h0000000000002f50+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002f40) |=>##1 IFID_NowPC_value (32'h0000000000002f40+32'h8);
