...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000030e0) |=>##1 IFID_NowPC_value (32'h00000000000030e0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000030d0) |=>##1 IFID_NowPC_value (32'h00000000000030d0+32'h8);
