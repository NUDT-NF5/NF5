...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002e60) |=>##1 IFID_NowPC_value (32'h0000000000002e60+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002e50) |=>##1 IFID_NowPC_value (32'h0000000000002e50+32'h8);
