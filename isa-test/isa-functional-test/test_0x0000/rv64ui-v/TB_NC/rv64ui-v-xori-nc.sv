...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002cbc) |=>##1 IFID_NowPC_value (32'h0000000000002cbc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002cac) |=>##1 IFID_NowPC_value (32'h0000000000002cac+32'h8);
