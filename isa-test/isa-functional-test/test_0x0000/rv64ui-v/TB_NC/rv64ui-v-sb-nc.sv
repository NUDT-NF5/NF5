...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002ecc) |=>##1 IFID_NowPC_value (32'h0000000000002ecc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002ebc) |=>##1 IFID_NowPC_value (32'h0000000000002ebc+32'h8);
