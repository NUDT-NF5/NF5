...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d44) |=>##1 IFID_NowPC_value (32'h0000000000002d44+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d34) |=>##1 IFID_NowPC_value (32'h0000000000002d34+32'h8);
