...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002fcc) |=>##1 IFID_NowPC_value (32'h0000000000002fcc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002fbc) |=>##1 IFID_NowPC_value (32'h0000000000002fbc+32'h8);
