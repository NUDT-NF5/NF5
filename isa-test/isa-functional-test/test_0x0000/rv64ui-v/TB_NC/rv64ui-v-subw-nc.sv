...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002f98) |=>##1 IFID_NowPC_value (32'h0000000000002f98+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002f88) |=>##1 IFID_NowPC_value (32'h0000000000002f88+32'h8);
