...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e5c) |=>##1 IFID_NowPC_value (32'h00002e5c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e4c) |=>##1 IFID_NowPC_value (32'h00002e4c+32'h8);
