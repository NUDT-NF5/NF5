...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000030a8) |=>##1 IFID_NowPC_value (32'h000030a8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00003098) |=>##1 IFID_NowPC_value (32'h00003098+32'h8);
