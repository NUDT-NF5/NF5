...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00003140) |=>##1 IFID_NowPC_value (32'h00003140+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00003130) |=>##1 IFID_NowPC_value (32'h00003130+32'h8);
