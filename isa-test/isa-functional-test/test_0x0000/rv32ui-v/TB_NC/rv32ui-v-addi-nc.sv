...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e78) |=>##1 IFID_NowPC_value (32'h00002e78+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e68) |=>##1 IFID_NowPC_value (32'h00002e68+32'h8);
