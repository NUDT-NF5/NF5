...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e90) |=>##1 IFID_NowPC_value (32'h00002e90+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e80) |=>##1 IFID_NowPC_value (32'h00002e80+32'h8);
