...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002c34) |=>##1 IFID_NowPC_value (32'h00002c34+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002c24) |=>##1 IFID_NowPC_value (32'h00002c24+32'h8);
