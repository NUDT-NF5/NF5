...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002eb4) |=>##1 IFID_NowPC_value (32'h00002eb4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002ea4) |=>##1 IFID_NowPC_value (32'h00002ea4+32'h8);
