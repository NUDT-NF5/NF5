...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e7c) |=>##1 IFID_NowPC_value (32'h00002e7c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e6c) |=>##1 IFID_NowPC_value (32'h00002e6c+32'h8);
