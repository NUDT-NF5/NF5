...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002f44) |=>##1 IFID_NowPC_value (32'h00002f44+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002f34) |=>##1 IFID_NowPC_value (32'h00002f34+32'h8);
