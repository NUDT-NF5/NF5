...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002ce8) |=>##1 IFID_NowPC_value (32'h00002ce8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002cd8) |=>##1 IFID_NowPC_value (32'h00002cd8+32'h8);
