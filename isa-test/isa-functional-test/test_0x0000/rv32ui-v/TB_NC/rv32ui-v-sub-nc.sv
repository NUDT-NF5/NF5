...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000030b0) |=>##1 IFID_NowPC_value (32'h000030b0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000030a0) |=>##1 IFID_NowPC_value (32'h000030a0+32'h8);
