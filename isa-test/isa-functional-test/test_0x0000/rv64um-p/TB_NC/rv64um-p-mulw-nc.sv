...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000004e8) |=>##1 IFID_NowPC_value (32'h00000000000004e8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000004d4) |=>##1 IFID_NowPC_value (32'h00000000000004d4+32'h8);
