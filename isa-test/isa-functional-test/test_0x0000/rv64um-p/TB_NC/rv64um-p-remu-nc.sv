...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000200) |=>##1 IFID_NowPC_value (32'h0000000000000200+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000001ec) |=>##1 IFID_NowPC_value (32'h00000000000001ec+32'h8);
