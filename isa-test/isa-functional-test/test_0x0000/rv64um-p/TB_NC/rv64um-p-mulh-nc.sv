...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000584) |=>##1 IFID_NowPC_value (32'h0000000000000584+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000570) |=>##1 IFID_NowPC_value (32'h0000000000000570+32'h8);
