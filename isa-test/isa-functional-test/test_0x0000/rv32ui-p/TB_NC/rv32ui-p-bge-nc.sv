...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000430) |=>##1 IFID_NowPC_value (32'h00000430+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000041c) |=>##1 IFID_NowPC_value (32'h0000041c+32'h8);
