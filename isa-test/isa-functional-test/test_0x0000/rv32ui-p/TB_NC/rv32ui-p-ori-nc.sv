...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000002ec) |=>##1 IFID_NowPC_value (32'h000002ec+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000002d8) |=>##1 IFID_NowPC_value (32'h000002d8+32'h8);
