...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000390) |=>##1 IFID_NowPC_value (32'h00000390+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000037c) |=>##1 IFID_NowPC_value (32'h0000037c+32'h8);
