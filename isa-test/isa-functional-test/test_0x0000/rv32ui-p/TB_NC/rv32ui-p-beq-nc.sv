...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000003d0) |=>##1 IFID_NowPC_value (32'h000003d0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000003bc) |=>##1 IFID_NowPC_value (32'h000003bc+32'h8);
