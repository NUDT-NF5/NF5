...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000005f0) |=>##1 IFID_NowPC_value (32'h000005f0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000005dc) |=>##1 IFID_NowPC_value (32'h000005dc+32'h8);
