...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000694) |=>##1 IFID_NowPC_value (32'h00000694+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000680) |=>##1 IFID_NowPC_value (32'h00000680+32'h8);
