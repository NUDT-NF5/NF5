...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002d84) |=>##1 IFID_NowPC_value (32'h00002d84+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002d74) |=>##1 IFID_NowPC_value (32'h00002d74+32'h8);
