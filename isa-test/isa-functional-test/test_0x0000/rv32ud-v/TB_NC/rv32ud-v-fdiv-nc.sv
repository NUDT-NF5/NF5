...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e18) |=>##1 IFID_NowPC_value (32'h00002e18+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002e08) |=>##1 IFID_NowPC_value (32'h00002e08+32'h8);
