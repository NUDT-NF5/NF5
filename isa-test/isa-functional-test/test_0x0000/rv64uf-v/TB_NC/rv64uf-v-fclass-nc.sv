...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bec) |=>##1 IFID_NowPC_value (32'h0000000000002bec+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002bdc) |=>##1 IFID_NowPC_value (32'h0000000000002bdc+32'h8);
