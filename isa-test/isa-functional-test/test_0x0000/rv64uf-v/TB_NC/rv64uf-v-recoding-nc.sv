...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b64) |=>##1 IFID_NowPC_value (32'h0000000000002b64+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b54) |=>##1 IFID_NowPC_value (32'h0000000000002b54+32'h8);
