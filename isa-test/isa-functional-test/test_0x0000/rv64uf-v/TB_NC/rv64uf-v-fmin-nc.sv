...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002e88) |=>##1 IFID_NowPC_value (32'h0000000000002e88+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002e78) |=>##1 IFID_NowPC_value (32'h0000000000002e78+32'h8);
