...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d9c) |=>##1 IFID_NowPC_value (32'h0000000000002d9c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002d8c) |=>##1 IFID_NowPC_value (32'h0000000000002d8c+32'h8);
