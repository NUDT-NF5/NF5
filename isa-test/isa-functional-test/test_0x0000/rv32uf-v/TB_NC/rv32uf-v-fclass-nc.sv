...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002cf4) |=>##1 IFID_NowPC_value (32'h00002cf4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002ce4) |=>##1 IFID_NowPC_value (32'h00002ce4+32'h8);
