...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002c88) |=>##1 IFID_NowPC_value (32'h00002c88+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00002c78) |=>##1 IFID_NowPC_value (32'h00002c78+32'h8);
