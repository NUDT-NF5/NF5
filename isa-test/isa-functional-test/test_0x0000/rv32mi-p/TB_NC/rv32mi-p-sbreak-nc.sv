...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000012c) |=>##1 IFID_NowPC_value (32'h0000012c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000118) |=>##1 IFID_NowPC_value (32'h00000118+32'h8);
