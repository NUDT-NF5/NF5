...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000002a0) |=>##1 IFID_NowPC_value (32'h000002a0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000028c) |=>##1 IFID_NowPC_value (32'h0000028c+32'h8);
