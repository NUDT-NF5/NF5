...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000025c) |=>##1 IFID_NowPC_value (32'h0000025c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000248) |=>##1 IFID_NowPC_value (32'h00000248+32'h8);
