...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000001fc) |=>##1 IFID_NowPC_value (32'h000001fc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000001e8) |=>##1 IFID_NowPC_value (32'h000001e8+32'h8);
