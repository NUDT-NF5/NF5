...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000017c) |=>##1 IFID_NowPC_value (32'h0000017c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000168) |=>##1 IFID_NowPC_value (32'h00000168+32'h8);
