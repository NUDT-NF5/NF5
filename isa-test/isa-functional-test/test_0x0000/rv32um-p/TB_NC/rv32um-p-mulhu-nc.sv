...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000005d8) |=>##1 IFID_NowPC_value (32'h000005d8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000005c4) |=>##1 IFID_NowPC_value (32'h000005c4+32'h8);
