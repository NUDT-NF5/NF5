...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000002b4) |=>##1 IFID_NowPC_value (32'h00000000000002b4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000002a0) |=>##1 IFID_NowPC_value (32'h00000000000002a0+32'h8);
