...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b3c) |=>##1 IFID_NowPC_value (32'h0000000000002b3c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b2c) |=>##1 IFID_NowPC_value (32'h0000000000002b2c+32'h8);
