...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b34) |=>##1 IFID_NowPC_value (32'h0000000000002b34+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000002b24) |=>##1 IFID_NowPC_value (32'h0000000000002b24+32'h8);
