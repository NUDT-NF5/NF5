...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000000000016c) |=>##1 IFID_NowPC_value (32'h000000000000016c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000158) |=>##1 IFID_NowPC_value (32'h0000000000000158+32'h8);
