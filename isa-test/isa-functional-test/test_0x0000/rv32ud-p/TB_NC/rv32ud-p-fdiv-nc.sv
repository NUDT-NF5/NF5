...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000340) |=>##1 IFID_NowPC_value (32'h00000340+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000032c) |=>##1 IFID_NowPC_value (32'h0000032c+32'h8);
