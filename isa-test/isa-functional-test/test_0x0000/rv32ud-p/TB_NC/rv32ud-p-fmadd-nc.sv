...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000450) |=>##1 IFID_NowPC_value (32'h00000450+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000043c) |=>##1 IFID_NowPC_value (32'h0000043c+32'h8);
