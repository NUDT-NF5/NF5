...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000238) |=>##1 IFID_NowPC_value (32'h00000238+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000224) |=>##1 IFID_NowPC_value (32'h00000224+32'h8);
