...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000002ac) |=>##1 IFID_NowPC_value (32'h000002ac+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000298) |=>##1 IFID_NowPC_value (32'h00000298+32'h8);
