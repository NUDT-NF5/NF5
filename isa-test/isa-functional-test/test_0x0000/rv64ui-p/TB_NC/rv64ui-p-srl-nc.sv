...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000718) |=>##1 IFID_NowPC_value (32'h0000000000000718+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000704) |=>##1 IFID_NowPC_value (32'h0000000000000704+32'h8);
