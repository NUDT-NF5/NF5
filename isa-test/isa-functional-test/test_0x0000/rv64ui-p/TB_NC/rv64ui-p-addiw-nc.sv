...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000398) |=>##1 IFID_NowPC_value (32'h0000000000000398+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000384) |=>##1 IFID_NowPC_value (32'h0000000000000384+32'h8);
