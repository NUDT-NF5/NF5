...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000408) |=>##1 IFID_NowPC_value (32'h0000000000000408+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000003f4) |=>##1 IFID_NowPC_value (32'h00000000000003f4+32'h8);
