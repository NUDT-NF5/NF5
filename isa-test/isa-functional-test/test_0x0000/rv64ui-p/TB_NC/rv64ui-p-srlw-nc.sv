...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000694) |=>##1 IFID_NowPC_value (32'h0000000000000694+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000680) |=>##1 IFID_NowPC_value (32'h0000000000000680+32'h8);
