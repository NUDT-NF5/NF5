...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000668) |=>##1 IFID_NowPC_value (32'h0000000000000668+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000654) |=>##1 IFID_NowPC_value (32'h0000000000000654+32'h8);
