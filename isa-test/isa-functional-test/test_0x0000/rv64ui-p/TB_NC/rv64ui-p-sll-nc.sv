...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000000000071c) |=>##1 IFID_NowPC_value (32'h000000000000071c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000708) |=>##1 IFID_NowPC_value (32'h0000000000000708+32'h8);
