...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000588) |=>##1 IFID_NowPC_value (32'h0000000000000588+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000574) |=>##1 IFID_NowPC_value (32'h0000000000000574+32'h8);
