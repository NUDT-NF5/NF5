...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000504) |=>##1 IFID_NowPC_value (32'h0000000000000504+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000004f0) |=>##1 IFID_NowPC_value (32'h00000000000004f0+32'h8);
