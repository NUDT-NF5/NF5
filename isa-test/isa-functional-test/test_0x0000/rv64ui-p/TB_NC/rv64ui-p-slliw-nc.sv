...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000394) |=>##1 IFID_NowPC_value (32'h0000000000000394+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000380) |=>##1 IFID_NowPC_value (32'h0000000000000380+32'h8);
