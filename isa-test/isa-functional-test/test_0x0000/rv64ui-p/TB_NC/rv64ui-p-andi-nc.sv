...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000308) |=>##1 IFID_NowPC_value (32'h0000000000000308+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000002f4) |=>##1 IFID_NowPC_value (32'h00000000000002f4+32'h8);
