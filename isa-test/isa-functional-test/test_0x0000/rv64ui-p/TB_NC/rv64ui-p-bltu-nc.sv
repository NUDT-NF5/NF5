...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000498) |=>##1 IFID_NowPC_value (32'h0000000000000498+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000484) |=>##1 IFID_NowPC_value (32'h0000000000000484+32'h8);
