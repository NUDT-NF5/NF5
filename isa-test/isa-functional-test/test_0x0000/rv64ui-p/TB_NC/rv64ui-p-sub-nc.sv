...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000005e0) |=>##1 IFID_NowPC_value (32'h00000000000005e0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000005cc) |=>##1 IFID_NowPC_value (32'h00000000000005cc+32'h8);
