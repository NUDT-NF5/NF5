...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000594) |=>##1 IFID_NowPC_value (32'h0000000000000594+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000580) |=>##1 IFID_NowPC_value (32'h0000000000000580+32'h8);
