...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000144) |=>##1 IFID_NowPC_value (32'h0000000000000144+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000000000130) |=>##1 IFID_NowPC_value (32'h0000000000000130+32'h8);
