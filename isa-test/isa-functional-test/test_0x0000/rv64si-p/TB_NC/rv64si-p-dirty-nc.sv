...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000001e4) |=>##1 IFID_NowPC_value (32'h00000000000001e4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000000001d0) |=>##1 IFID_NowPC_value (32'h00000000000001d0+32'h8);
