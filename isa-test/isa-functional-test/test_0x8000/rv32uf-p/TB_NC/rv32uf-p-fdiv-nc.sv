...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000028c) |=>##1 IFID_NowPC_value (32'h8000028c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000278) |=>##1 IFID_NowPC_value (32'h80000278+32'h8);
