...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000160) |=>##1 IFID_NowPC_value (32'h80000160+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000014c) |=>##1 IFID_NowPC_value (32'h8000014c+32'h8);
