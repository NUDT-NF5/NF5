...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800003ac) |=>##1 IFID_NowPC_value (32'h800003ac+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000398) |=>##1 IFID_NowPC_value (32'h80000398+32'h8);
