...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000050c) |=>##1 IFID_NowPC_value (32'h8000050c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800004f8) |=>##1 IFID_NowPC_value (32'h800004f8+32'h8);
