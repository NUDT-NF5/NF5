...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800003f0) |=>##1 IFID_NowPC_value (32'h800003f0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800003dc) |=>##1 IFID_NowPC_value (32'h800003dc+32'h8);
