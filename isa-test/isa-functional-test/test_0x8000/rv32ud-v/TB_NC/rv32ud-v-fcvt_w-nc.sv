...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002fe4) |=>##1 IFID_NowPC_value (32'h80002fe4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002fd4) |=>##1 IFID_NowPC_value (32'h80002fd4+32'h8);
