...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002f7c) |=>##1 IFID_NowPC_value (32'h80002f7c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002f6c) |=>##1 IFID_NowPC_value (32'h80002f6c+32'h8);
