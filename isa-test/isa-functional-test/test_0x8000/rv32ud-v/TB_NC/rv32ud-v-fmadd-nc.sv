...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002f28) |=>##1 IFID_NowPC_value (32'h80002f28+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002f18) |=>##1 IFID_NowPC_value (32'h80002f18+32'h8);
