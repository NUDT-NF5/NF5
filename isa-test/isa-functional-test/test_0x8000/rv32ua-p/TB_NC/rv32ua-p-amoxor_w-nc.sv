...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000017c) |=>##1 IFID_NowPC_value (32'h8000017c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000168) |=>##1 IFID_NowPC_value (32'h80000168+32'h8);
