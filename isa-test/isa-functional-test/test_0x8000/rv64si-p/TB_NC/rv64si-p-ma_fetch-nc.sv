...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800001c8) |=>##1 IFID_NowPC_value (32'h00000000800001c8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800001b4) |=>##1 IFID_NowPC_value (32'h00000000800001b4+32'h8);
