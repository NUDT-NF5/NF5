...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000144) |=>##1 IFID_NowPC_value (32'h0000000080000144+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000130) |=>##1 IFID_NowPC_value (32'h0000000080000130+32'h8);
