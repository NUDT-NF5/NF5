...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000154) |=>##1 IFID_NowPC_value (32'h0000000080000154+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000140) |=>##1 IFID_NowPC_value (32'h0000000080000140+32'h8);
