...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002ee4) |=>##1 IFID_NowPC_value (32'h80002ee4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002ed4) |=>##1 IFID_NowPC_value (32'h80002ed4+32'h8);
