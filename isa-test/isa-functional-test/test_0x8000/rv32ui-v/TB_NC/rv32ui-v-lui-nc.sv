...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002c50) |=>##1 IFID_NowPC_value (32'h80002c50+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002c40) |=>##1 IFID_NowPC_value (32'h80002c40+32'h8);
