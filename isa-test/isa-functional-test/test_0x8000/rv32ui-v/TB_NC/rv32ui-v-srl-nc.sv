...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003174) |=>##1 IFID_NowPC_value (32'h80003174+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003164) |=>##1 IFID_NowPC_value (32'h80003164+32'h8);
