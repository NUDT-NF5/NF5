...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003074) |=>##1 IFID_NowPC_value (32'h80003074+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003064) |=>##1 IFID_NowPC_value (32'h80003064+32'h8);
