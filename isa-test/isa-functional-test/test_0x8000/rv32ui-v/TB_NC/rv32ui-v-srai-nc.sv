...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002ea8) |=>##1 IFID_NowPC_value (32'h80002ea8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e98) |=>##1 IFID_NowPC_value (32'h80002e98+32'h8);
