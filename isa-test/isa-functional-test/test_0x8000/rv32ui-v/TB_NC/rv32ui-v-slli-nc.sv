...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e74) |=>##1 IFID_NowPC_value (32'h80002e74+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e64) |=>##1 IFID_NowPC_value (32'h80002e64+32'h8);
