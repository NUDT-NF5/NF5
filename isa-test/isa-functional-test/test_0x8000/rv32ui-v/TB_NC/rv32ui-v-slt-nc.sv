...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800030b8) |=>##1 IFID_NowPC_value (32'h800030b8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800030a8) |=>##1 IFID_NowPC_value (32'h800030a8+32'h8);
