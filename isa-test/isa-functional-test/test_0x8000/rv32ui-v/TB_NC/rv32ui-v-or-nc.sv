...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800030b4) |=>##1 IFID_NowPC_value (32'h800030b4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800030a4) |=>##1 IFID_NowPC_value (32'h800030a4+32'h8);
