...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003140) |=>##1 IFID_NowPC_value (32'h80003140+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003130) |=>##1 IFID_NowPC_value (32'h80003130+32'h8);
