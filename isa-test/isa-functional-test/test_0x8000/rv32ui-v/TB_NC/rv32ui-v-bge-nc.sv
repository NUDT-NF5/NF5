...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002f10) |=>##1 IFID_NowPC_value (32'h80002f10+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002f00) |=>##1 IFID_NowPC_value (32'h80002f00+32'h8);
