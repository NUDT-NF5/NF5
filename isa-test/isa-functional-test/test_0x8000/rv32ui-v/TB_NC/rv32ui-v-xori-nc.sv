...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002dd4) |=>##1 IFID_NowPC_value (32'h80002dd4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002dc4) |=>##1 IFID_NowPC_value (32'h80002dc4+32'h8);
