...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002dcc) |=>##1 IFID_NowPC_value (32'h80002dcc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002dbc) |=>##1 IFID_NowPC_value (32'h80002dbc+32'h8);
