...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002cc4) |=>##1 IFID_NowPC_value (32'h80002cc4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002cb4) |=>##1 IFID_NowPC_value (32'h80002cb4+32'h8);
