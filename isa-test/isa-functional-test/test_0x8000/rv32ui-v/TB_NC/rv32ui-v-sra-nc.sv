...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000318c) |=>##1 IFID_NowPC_value (32'h8000318c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000317c) |=>##1 IFID_NowPC_value (32'h8000317c+32'h8);
