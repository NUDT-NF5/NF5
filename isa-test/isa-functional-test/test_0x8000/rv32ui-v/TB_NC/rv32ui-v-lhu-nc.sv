...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e70) |=>##1 IFID_NowPC_value (32'h80002e70+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e60) |=>##1 IFID_NowPC_value (32'h80002e60+32'h8);
