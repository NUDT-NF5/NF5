...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002c44) |=>##1 IFID_NowPC_value (32'h80002c44+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002c34) |=>##1 IFID_NowPC_value (32'h80002c34+32'h8);
