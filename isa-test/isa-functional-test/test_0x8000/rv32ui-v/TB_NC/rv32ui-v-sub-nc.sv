...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800030b0) |=>##1 IFID_NowPC_value (32'h800030b0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800030a0) |=>##1 IFID_NowPC_value (32'h800030a0+32'h8);
