...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003068) |=>##1 IFID_NowPC_value (32'h80003068+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80003058) |=>##1 IFID_NowPC_value (32'h80003058+32'h8);
