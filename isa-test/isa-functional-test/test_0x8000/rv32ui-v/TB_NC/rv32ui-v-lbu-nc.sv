...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e3c) |=>##1 IFID_NowPC_value (32'h80002e3c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e2c) |=>##1 IFID_NowPC_value (32'h80002e2c+32'h8);
