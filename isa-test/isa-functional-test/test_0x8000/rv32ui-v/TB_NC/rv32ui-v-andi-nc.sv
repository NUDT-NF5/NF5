...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002db0) |=>##1 IFID_NowPC_value (32'h80002db0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002da0) |=>##1 IFID_NowPC_value (32'h80002da0+32'h8);
