...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000174) |=>##1 IFID_NowPC_value (32'h0000000080000174+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000160) |=>##1 IFID_NowPC_value (32'h0000000080000160+32'h8);
