...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000240) |=>##1 IFID_NowPC_value (32'h0000000080000240+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000022c) |=>##1 IFID_NowPC_value (32'h000000008000022c+32'h8);
