...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000878) |=>##1 IFID_NowPC_value (32'h0000000080000878+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000864) |=>##1 IFID_NowPC_value (32'h0000000080000864+32'h8);
