...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800002ac) |=>##1 IFID_NowPC_value (32'h800002ac+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000298) |=>##1 IFID_NowPC_value (32'h80000298+32'h8);
