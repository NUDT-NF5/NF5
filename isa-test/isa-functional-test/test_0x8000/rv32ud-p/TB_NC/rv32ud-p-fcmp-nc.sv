...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800004a4) |=>##1 IFID_NowPC_value (32'h800004a4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000490) |=>##1 IFID_NowPC_value (32'h80000490+32'h8);
