...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800005e8) |=>##1 IFID_NowPC_value (32'h800005e8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800005d4) |=>##1 IFID_NowPC_value (32'h800005d4+32'h8);
