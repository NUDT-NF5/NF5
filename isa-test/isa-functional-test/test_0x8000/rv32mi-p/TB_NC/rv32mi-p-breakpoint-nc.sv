...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000224) |=>##1 IFID_NowPC_value (32'h80000224+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000210) |=>##1 IFID_NowPC_value (32'h80000210+32'h8);
