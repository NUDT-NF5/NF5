...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000218) |=>##1 IFID_NowPC_value (32'h80000218+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000204) |=>##1 IFID_NowPC_value (32'h80000204+32'h8);
