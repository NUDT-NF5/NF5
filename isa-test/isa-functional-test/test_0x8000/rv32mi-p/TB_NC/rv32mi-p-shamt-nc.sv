...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000144) |=>##1 IFID_NowPC_value (32'h80000144+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000130) |=>##1 IFID_NowPC_value (32'h80000130+32'h8);
