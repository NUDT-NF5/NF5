...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000025c) |=>##1 IFID_NowPC_value (32'h8000025c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000248) |=>##1 IFID_NowPC_value (32'h80000248+32'h8);
