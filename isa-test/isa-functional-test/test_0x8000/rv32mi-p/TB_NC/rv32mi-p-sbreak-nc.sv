...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000012c) |=>##1 IFID_NowPC_value (32'h8000012c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000118) |=>##1 IFID_NowPC_value (32'h80000118+32'h8);
