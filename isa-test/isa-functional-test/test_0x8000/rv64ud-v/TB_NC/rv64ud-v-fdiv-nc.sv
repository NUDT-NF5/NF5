...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002c80) |=>##1 IFID_NowPC_value (32'h0000000080002c80+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002c70) |=>##1 IFID_NowPC_value (32'h0000000080002c70+32'h8);
