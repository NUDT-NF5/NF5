...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800039b8) |=>##1 IFID_NowPC_value (32'h00000000800039b8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800039a8) |=>##1 IFID_NowPC_value (32'h00000000800039a8+32'h8);
