...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080003328) |=>##1 IFID_NowPC_value (32'h0000000080003328+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080003318) |=>##1 IFID_NowPC_value (32'h0000000080003318+32'h8);
