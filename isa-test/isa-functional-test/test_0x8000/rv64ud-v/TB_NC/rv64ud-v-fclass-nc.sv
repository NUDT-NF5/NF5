...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002c04) |=>##1 IFID_NowPC_value (32'h0000000080002c04+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bf4) |=>##1 IFID_NowPC_value (32'h0000000080002bf4+32'h8);
