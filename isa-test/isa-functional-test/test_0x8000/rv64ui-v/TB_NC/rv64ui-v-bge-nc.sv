...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002df8) |=>##1 IFID_NowPC_value (32'h0000000080002df8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002de8) |=>##1 IFID_NowPC_value (32'h0000000080002de8+32'h8);
