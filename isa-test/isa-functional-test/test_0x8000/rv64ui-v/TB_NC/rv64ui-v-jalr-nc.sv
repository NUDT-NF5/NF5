...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bac) |=>##1 IFID_NowPC_value (32'h0000000080002bac+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002b9c) |=>##1 IFID_NowPC_value (32'h0000000080002b9c+32'h8);
