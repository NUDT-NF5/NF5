...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002ea4) |=>##1 IFID_NowPC_value (32'h0000000080002ea4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002e94) |=>##1 IFID_NowPC_value (32'h0000000080002e94+32'h8);
