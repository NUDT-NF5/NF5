...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002dd0) |=>##1 IFID_NowPC_value (32'h0000000080002dd0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002dc0) |=>##1 IFID_NowPC_value (32'h0000000080002dc0+32'h8);
