...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080003074) |=>##1 IFID_NowPC_value (32'h0000000080003074+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080003064) |=>##1 IFID_NowPC_value (32'h0000000080003064+32'h8);
