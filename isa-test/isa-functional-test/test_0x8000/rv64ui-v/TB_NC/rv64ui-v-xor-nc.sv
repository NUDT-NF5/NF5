...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800030a0) |=>##1 IFID_NowPC_value (32'h00000000800030a0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080003090) |=>##1 IFID_NowPC_value (32'h0000000080003090+32'h8);
