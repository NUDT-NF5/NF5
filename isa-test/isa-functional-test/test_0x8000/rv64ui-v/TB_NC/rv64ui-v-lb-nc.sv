...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002d24) |=>##1 IFID_NowPC_value (32'h0000000080002d24+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002d14) |=>##1 IFID_NowPC_value (32'h0000000080002d14+32'h8);
