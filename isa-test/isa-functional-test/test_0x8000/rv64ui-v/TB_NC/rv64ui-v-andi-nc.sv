...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002cd0) |=>##1 IFID_NowPC_value (32'h0000000080002cd0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002cc0) |=>##1 IFID_NowPC_value (32'h0000000080002cc0+32'h8);
