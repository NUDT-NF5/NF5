...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002ecc) |=>##1 IFID_NowPC_value (32'h0000000080002ecc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002ebc) |=>##1 IFID_NowPC_value (32'h0000000080002ebc+32'h8);
