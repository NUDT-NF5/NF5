...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002b2c) |=>##1 IFID_NowPC_value (32'h0000000080002b2c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002b1c) |=>##1 IFID_NowPC_value (32'h0000000080002b1c+32'h8);
