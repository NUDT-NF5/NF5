...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002d78) |=>##1 IFID_NowPC_value (32'h0000000080002d78+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002d68) |=>##1 IFID_NowPC_value (32'h0000000080002d68+32'h8);
