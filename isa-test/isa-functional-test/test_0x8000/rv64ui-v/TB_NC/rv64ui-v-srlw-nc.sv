...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000305c) |=>##1 IFID_NowPC_value (32'h000000008000305c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000304c) |=>##1 IFID_NowPC_value (32'h000000008000304c+32'h8);
