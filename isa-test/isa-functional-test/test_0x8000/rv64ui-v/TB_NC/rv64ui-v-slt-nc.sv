...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002fa0) |=>##1 IFID_NowPC_value (32'h0000000080002fa0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002f90) |=>##1 IFID_NowPC_value (32'h0000000080002f90+32'h8);
