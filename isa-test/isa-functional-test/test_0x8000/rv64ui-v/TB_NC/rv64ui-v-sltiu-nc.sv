...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002d4c) |=>##1 IFID_NowPC_value (32'h0000000080002d4c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002d3c) |=>##1 IFID_NowPC_value (32'h0000000080002d3c+32'h8);
