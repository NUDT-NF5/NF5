...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000311c) |=>##1 IFID_NowPC_value (32'h000000008000311c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000310c) |=>##1 IFID_NowPC_value (32'h000000008000310c+32'h8);
