...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002cbc) |=>##1 IFID_NowPC_value (32'h0000000080002cbc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002cac) |=>##1 IFID_NowPC_value (32'h0000000080002cac+32'h8);
