...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bb4) |=>##1 IFID_NowPC_value (32'h0000000080002bb4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002ba4) |=>##1 IFID_NowPC_value (32'h0000000080002ba4+32'h8);
