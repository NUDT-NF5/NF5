...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002eb0) |=>##1 IFID_NowPC_value (32'h0000000080002eb0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002ea0) |=>##1 IFID_NowPC_value (32'h0000000080002ea0+32'h8);
