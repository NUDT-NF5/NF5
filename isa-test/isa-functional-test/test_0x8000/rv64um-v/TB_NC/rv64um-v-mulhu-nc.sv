...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002fcc) |=>##1 IFID_NowPC_value (32'h0000000080002fcc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002fbc) |=>##1 IFID_NowPC_value (32'h0000000080002fbc+32'h8);
