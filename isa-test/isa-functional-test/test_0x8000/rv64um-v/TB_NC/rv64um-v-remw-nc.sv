...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bcc) |=>##1 IFID_NowPC_value (32'h0000000080002bcc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bbc) |=>##1 IFID_NowPC_value (32'h0000000080002bbc+32'h8);
