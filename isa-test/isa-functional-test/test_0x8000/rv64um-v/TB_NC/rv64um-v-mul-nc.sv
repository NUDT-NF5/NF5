...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002fa4) |=>##1 IFID_NowPC_value (32'h0000000080002fa4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002f94) |=>##1 IFID_NowPC_value (32'h0000000080002f94+32'h8);
