...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800052dc) |=>##1 IFID_NowPC_value (32'h00000000800052dc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800052cc) |=>##1 IFID_NowPC_value (32'h00000000800052cc+32'h8);
