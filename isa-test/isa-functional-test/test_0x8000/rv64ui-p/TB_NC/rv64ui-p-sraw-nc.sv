...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800006ac) |=>##1 IFID_NowPC_value (32'h00000000800006ac+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000698) |=>##1 IFID_NowPC_value (32'h0000000080000698+32'h8);
