...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000040c) |=>##1 IFID_NowPC_value (32'h000000008000040c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800003f8) |=>##1 IFID_NowPC_value (32'h00000000800003f8+32'h8);
