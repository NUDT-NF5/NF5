...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000718) |=>##1 IFID_NowPC_value (32'h0000000080000718+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000704) |=>##1 IFID_NowPC_value (32'h0000000080000704+32'h8);
