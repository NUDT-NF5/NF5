...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800002fc) |=>##1 IFID_NowPC_value (32'h00000000800002fc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800002e8) |=>##1 IFID_NowPC_value (32'h00000000800002e8+32'h8);
