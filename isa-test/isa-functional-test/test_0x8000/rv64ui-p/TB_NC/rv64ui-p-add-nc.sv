...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000604) |=>##1 IFID_NowPC_value (32'h0000000080000604+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800005f0) |=>##1 IFID_NowPC_value (32'h00000000800005f0+32'h8);
