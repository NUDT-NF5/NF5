...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800006ec) |=>##1 IFID_NowPC_value (32'h00000000800006ec+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800006d8) |=>##1 IFID_NowPC_value (32'h00000000800006d8+32'h8);
