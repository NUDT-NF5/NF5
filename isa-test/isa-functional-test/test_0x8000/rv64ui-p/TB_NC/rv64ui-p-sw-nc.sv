...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000594) |=>##1 IFID_NowPC_value (32'h0000000080000594+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000580) |=>##1 IFID_NowPC_value (32'h0000000080000580+32'h8);
