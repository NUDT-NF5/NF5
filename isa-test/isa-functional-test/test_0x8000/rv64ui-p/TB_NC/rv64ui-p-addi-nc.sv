...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800003a4) |=>##1 IFID_NowPC_value (32'h00000000800003a4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000390) |=>##1 IFID_NowPC_value (32'h0000000080000390+32'h8);
