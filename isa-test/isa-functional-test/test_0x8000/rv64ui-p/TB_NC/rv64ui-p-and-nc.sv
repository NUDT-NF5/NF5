...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000668) |=>##1 IFID_NowPC_value (32'h0000000080000668+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000654) |=>##1 IFID_NowPC_value (32'h0000000080000654+32'h8);
