...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000061c) |=>##1 IFID_NowPC_value (32'h000000008000061c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000608) |=>##1 IFID_NowPC_value (32'h0000000080000608+32'h8);
