...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000754) |=>##1 IFID_NowPC_value (32'h0000000080000754+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000740) |=>##1 IFID_NowPC_value (32'h0000000080000740+32'h8);
