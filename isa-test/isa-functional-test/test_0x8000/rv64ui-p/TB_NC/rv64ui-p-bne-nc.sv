...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800003d4) |=>##1 IFID_NowPC_value (32'h00000000800003d4+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800003c0) |=>##1 IFID_NowPC_value (32'h00000000800003c0+32'h8);
