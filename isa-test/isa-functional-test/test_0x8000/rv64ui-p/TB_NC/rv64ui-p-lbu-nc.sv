...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h000000008000035c) |=>##1 IFID_NowPC_value (32'h000000008000035c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000348) |=>##1 IFID_NowPC_value (32'h0000000080000348+32'h8);
