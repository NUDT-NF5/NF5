...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002e00) |=>##1 IFID_NowPC_value (32'h80002e00+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002df0) |=>##1 IFID_NowPC_value (32'h80002df0+32'h8);
