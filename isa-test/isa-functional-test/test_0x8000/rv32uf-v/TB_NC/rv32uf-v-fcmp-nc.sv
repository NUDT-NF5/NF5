...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002ec8) |=>##1 IFID_NowPC_value (32'h80002ec8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002eb8) |=>##1 IFID_NowPC_value (32'h80002eb8+32'h8);
