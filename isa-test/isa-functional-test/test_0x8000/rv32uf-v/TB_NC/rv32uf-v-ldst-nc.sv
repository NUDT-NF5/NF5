...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002c38) |=>##1 IFID_NowPC_value (32'h80002c38+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002c28) |=>##1 IFID_NowPC_value (32'h80002c28+32'h8);
