...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002d64) |=>##1 IFID_NowPC_value (32'h80002d64+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002d54) |=>##1 IFID_NowPC_value (32'h80002d54+32'h8);
