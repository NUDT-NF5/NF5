...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002ccc) |=>##1 IFID_NowPC_value (32'h80002ccc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002cbc) |=>##1 IFID_NowPC_value (32'h80002cbc+32'h8);
