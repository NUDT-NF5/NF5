...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002cd0) |=>##1 IFID_NowPC_value (32'h80002cd0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002cc0) |=>##1 IFID_NowPC_value (32'h80002cc0+32'h8);
