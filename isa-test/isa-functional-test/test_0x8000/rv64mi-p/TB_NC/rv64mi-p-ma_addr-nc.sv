...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800005fc) |=>##1 IFID_NowPC_value (32'h00000000800005fc+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800005e8) |=>##1 IFID_NowPC_value (32'h00000000800005e8+32'h8);
