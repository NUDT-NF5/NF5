...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000224) |=>##1 IFID_NowPC_value (32'h0000000080000224+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000210) |=>##1 IFID_NowPC_value (32'h0000000080000210+32'h8);
