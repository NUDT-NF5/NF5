...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002b40) |=>##1 IFID_NowPC_value (32'h0000000080002b40+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002b30) |=>##1 IFID_NowPC_value (32'h0000000080002b30+32'h8);
