...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002b38) |=>##1 IFID_NowPC_value (32'h0000000080002b38+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002b28) |=>##1 IFID_NowPC_value (32'h0000000080002b28+32'h8);
