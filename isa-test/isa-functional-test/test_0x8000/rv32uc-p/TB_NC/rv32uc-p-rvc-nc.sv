...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000225c) |=>##1 IFID_NowPC_value (32'h8000225c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80002248) |=>##1 IFID_NowPC_value (32'h80002248+32'h8);
