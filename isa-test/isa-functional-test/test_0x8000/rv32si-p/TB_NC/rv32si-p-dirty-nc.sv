...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800001e0) |=>##1 IFID_NowPC_value (32'h800001e0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800001cc) |=>##1 IFID_NowPC_value (32'h800001cc+32'h8);
