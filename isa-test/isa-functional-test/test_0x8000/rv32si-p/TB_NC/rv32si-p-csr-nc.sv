...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000200) |=>##1 IFID_NowPC_value (32'h80000200+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800001ec) |=>##1 IFID_NowPC_value (32'h800001ec+32'h8);
