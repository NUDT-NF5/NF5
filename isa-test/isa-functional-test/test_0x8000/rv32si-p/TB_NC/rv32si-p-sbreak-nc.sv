...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000134) |=>##1 IFID_NowPC_value (32'h80000134+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000120) |=>##1 IFID_NowPC_value (32'h80000120+32'h8);
