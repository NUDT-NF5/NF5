...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000394) |=>##1 IFID_NowPC_value (32'h80000394+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000380) |=>##1 IFID_NowPC_value (32'h80000380+32'h8);
