...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000464) |=>##1 IFID_NowPC_value (32'h80000464+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000450) |=>##1 IFID_NowPC_value (32'h80000450+32'h8);
