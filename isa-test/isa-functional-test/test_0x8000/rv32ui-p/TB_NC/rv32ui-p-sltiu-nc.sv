...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000384) |=>##1 IFID_NowPC_value (32'h80000384+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000370) |=>##1 IFID_NowPC_value (32'h80000370+32'h8);
