...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000035c) |=>##1 IFID_NowPC_value (32'h8000035c+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000348) |=>##1 IFID_NowPC_value (32'h80000348+32'h8);
