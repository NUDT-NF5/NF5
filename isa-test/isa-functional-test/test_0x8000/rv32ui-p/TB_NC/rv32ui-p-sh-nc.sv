...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000588) |=>##1 IFID_NowPC_value (32'h80000588+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000574) |=>##1 IFID_NowPC_value (32'h80000574+32'h8);
