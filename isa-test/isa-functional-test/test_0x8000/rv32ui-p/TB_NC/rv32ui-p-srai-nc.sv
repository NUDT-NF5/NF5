...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800003c8) |=>##1 IFID_NowPC_value (32'h800003c8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800003b4) |=>##1 IFID_NowPC_value (32'h800003b4+32'h8);
