...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000170) |=>##1 IFID_NowPC_value (32'h80000170+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000015c) |=>##1 IFID_NowPC_value (32'h8000015c+32'h8);
