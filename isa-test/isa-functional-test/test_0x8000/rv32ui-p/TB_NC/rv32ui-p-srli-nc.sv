...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h800003b0) |=>##1 IFID_NowPC_value (32'h800003b0+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000039c) |=>##1 IFID_NowPC_value (32'h8000039c+32'h8);
