...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000430) |=>##1 IFID_NowPC_value (32'h80000430+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000041c) |=>##1 IFID_NowPC_value (32'h8000041c+32'h8);
