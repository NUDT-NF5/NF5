...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000164) |=>##1 IFID_NowPC_value (32'h80000164+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000150) |=>##1 IFID_NowPC_value (32'h80000150+32'h8);
