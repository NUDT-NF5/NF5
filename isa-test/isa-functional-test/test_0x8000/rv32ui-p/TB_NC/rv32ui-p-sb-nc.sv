...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000504) |=>##1 IFID_NowPC_value (32'h80000504+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h800004f0) |=>##1 IFID_NowPC_value (32'h800004f0+32'h8);
