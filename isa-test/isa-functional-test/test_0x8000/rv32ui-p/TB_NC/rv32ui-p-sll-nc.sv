...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h80000660) |=>##1 IFID_NowPC_value (32'h80000660+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h8000064c) |=>##1 IFID_NowPC_value (32'h8000064c+32'h8);
