...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000ff8) |=>##1 IFID_NowPC_value (32'h0000000080000ff8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000fe4) |=>##1 IFID_NowPC_value (32'h0000000080000fe4+32'h8);
