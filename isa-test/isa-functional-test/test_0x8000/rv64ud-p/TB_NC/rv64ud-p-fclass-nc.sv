...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000244) |=>##1 IFID_NowPC_value (32'h0000000080000244+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000230) |=>##1 IFID_NowPC_value (32'h0000000080000230+32'h8);
