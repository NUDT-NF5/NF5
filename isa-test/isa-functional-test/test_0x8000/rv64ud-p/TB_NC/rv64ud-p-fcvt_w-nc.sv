...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000968) |=>##1 IFID_NowPC_value (32'h0000000080000968+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000954) |=>##1 IFID_NowPC_value (32'h0000000080000954+32'h8);
