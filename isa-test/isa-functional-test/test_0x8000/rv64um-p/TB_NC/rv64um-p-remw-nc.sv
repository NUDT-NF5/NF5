...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080000204) |=>##1 IFID_NowPC_value (32'h0000000080000204+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800001f0) |=>##1 IFID_NowPC_value (32'h00000000800001f0+32'h8);
