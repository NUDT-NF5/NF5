...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800004e8) |=>##1 IFID_NowPC_value (32'h00000000800004e8+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h00000000800004d4) |=>##1 IFID_NowPC_value (32'h00000000800004d4+32'h8);
