...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080003238) |=>##1 IFID_NowPC_value (32'h0000000080003238+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080003228) |=>##1 IFID_NowPC_value (32'h0000000080003228+32'h8);
