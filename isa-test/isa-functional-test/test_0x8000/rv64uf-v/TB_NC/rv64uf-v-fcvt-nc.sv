...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002c00) |=>##1 IFID_NowPC_value (32'h0000000080002c00+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bf0) |=>##1 IFID_NowPC_value (32'h0000000080002bf0+32'h8);
