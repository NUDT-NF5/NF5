...
property Pass_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bec) |=>##1 IFID_NowPC_value (32'h0000000080002bec+32'h8);

endproperty

property Fail_PC;
  @(posedge clk) IFID_NowPC_value (32'h0000000080002bdc) |=>##1 IFID_NowPC_value (32'h0000000080002bdc+32'h8);
