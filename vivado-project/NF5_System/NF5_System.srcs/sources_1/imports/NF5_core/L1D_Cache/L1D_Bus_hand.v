...
// Ports of Axi Master Bus Interface M00_AXI
    ...
    output wire [C_M00_AXI_ID_WIDTH-1   : 0]     m00_axi_wid        ,    //output                                                
		...
		input  wire [1 : 0]                          m00_axi_bresp      ,    //input-------  useless
		...
		input  wire [1 : 0]                          m00_axi_rresp      ,    //input---------- useless
...
reg  [5:0]      next_state;
    ...
    //assign rd_last          = m00_axi_rlast&&(m00_axi_rid==1);
    assign rd_last          = m00_axi_rlast && m00_axi_rvalid;
    // assign wrt_last         = m00_axi_reg_wlast && m00_axi_bvalid;
    assign wrt_last         = m00_axi_bvalid;
    ...
    case( current_state )
      ...
      Wrt_Rsp:
        /*if( readbus_en && m00_axi_bvalid )
                ...
                next_state = Wrt_Addr;*/
//        if(m00_axi_bvalid && (m00_axi_bid==1)&&(m00_axi_bresp==0))  
        if(m00_axi_bvalid &&(m00_axi_bresp==0))  
      ...
      Rd_Data:
        /*if( writebus_en && m00_axi_rlast )
                ...
                next_state = Rd_Addr;*/
//        if( m00_axi_rlast&&(m00_axi_rid==1) )            //m00_axi_rlast == 1 indicate read has been finished
        if( m00_axi_rlast && m00_axi_rvalid )            //m00_axi_rlast == 1 indicate read has been finished
                next_state = Idle_axi;
        else
                next_state = Rd_Data;
...
//             m00_axi_reg_arid     = 1;         
      ...
      Rd_Data:
        begin
            ...
            //if( m00_axi_rvalid&&(m00_axi_rid==1)&&(m00_axi_rresp==0))
            if( m00_axi_rvalid&&(m00_axi_rresp==0))
      ...
      default:
        begin
            m00_axi_reg_bready   = 0;          //bready always is 1,so the master can receive write finish response signal
        end
    endcase
  end
