...
`define	RS_SEL_EX_0			`RS_SEL_WIDTH'd1
`define	RS_SEL_EXMem_0		`RS_SEL_WIDTH'd2
`define	RS_SEL_Dcache_0		`RS_SEL_WIDTH'd3
`define	RS_SEL_Wb_0			`RS_SEL_WIDTH'd4
`define	RS_SEL_RF_1 		`RS_SEL_WIDTH'd5
`define	RS_SEL_EX_1			`RS_SEL_WIDTH'd6
`define	RS_SEL_EXMem_1		`RS_SEL_WIDTH'd7
`define	RS_SEL_Dcache_1		`RS_SEL_WIDTH'd8
